  ...
  return (
    <FlexCenter>
      ...
      <Section style={{ marginTop: '2rem' }}>
          ...
          <ScrollX>
            {detailList?.imageUrl.map((img, idx) => (
              <ScrollXChild key={idx}>
                <Img bradius="20px" others="margin-bottom:1rem" src={img} />
              </ScrollXChild>
            ))}
          </ScrollX>
        </ScrollX>
        ...
        <Text others="margin-top:0.7rem;">{detailList?.locationName}</Text>
        <Hr />
      </Section>
      <Section>
      ...
      <Section>
        <div>
          <h2>
            <i className="fas fa-home"></i> {detailList?.category} 전체
          </h2>
        ...
        <div>
          ...
          <Text others="margin-left:1.5rem">
            최근 숙박한 게스트 중 90%가 체크인 과정에 별점 {detailList?.rating}
            점을 준 숙소입니다.
          </Text>
        </div>
        <div>
        ...
        <ScrollX>
          <ScrollXChild>
            ...
            {reserveStatus === 2 && (
              ...
              >
                <Text fontSize="1.2rem">체크인 날짜 : {checkInDate}</Text>
                <Text fontSize="1.2rem">체크아웃 : {checkOutDate}</Text>
          ...
          <ReviewBox>
            ...
            >
              <div>
                ...
                <Text bold="700" fontSize="1rem" others="margin-bottom:1rem">
                  리뷰 단 시간 뿌리는곳
                </Text>
                {reviewState ? (
                  <UpdateInput
              ...
              <div style={{ width: '3rem' }}>
                ...
                <OptionBtn onClick={updateReview}>수정</OptionBtn>
              </div>
            </div>
          </ReviewBox>
        </ScrollX>
