...
const MainHeader = () => {
  ...
  const readRooms = () => {
    if (checkInDate === '' || checkOutDate === '' || counter === 0) {
      window.alert('체크인 날짜, 체크아웃 날짜, 인원 수를 전부 선택해주세요.')
    }
  ...
  return (
    ...
    >
      ...
      <HeaderFeatures className="input-ani">
        <FeaturesBtn>
          <ColumnText>
      ...
      {readStatus > 0 && (
        <Modal>
          ...
          {readStatus === 1 && (
            <Text bold="700" fontSize="2rem" others="margin-bottom:1.3rem;">
              체크인
            </Text>
          )}
          {readStatus === 2 && (
          ...
          {readStatus === 3 && (
            ...
            >
              <Flex style={{ flexDirection: 'row' }}>
                ...
                <Text fontSize="1.6rem" others="margin:0 0.5rem;">
                  {counter}
                </Text>
